...
-------------------------- factory methods -----------------------------
function ConvGRU:buildModel(ConvNN)
	...
	t1:add(ConvNN or nn.Linear(self.inputSize, self.outputSize))
...
function ConvGRU:_updateGradInput(input, gradOutput)
...
function ConvGRU:_accGradParameters(input, gradOutput, scale)
